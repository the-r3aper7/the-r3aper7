import { FileMetadata, Frontmatter, getPost, getPosts } from "@/src/utils/markdownUtils";
...
function BlogItem(props: FileMetadata) {
  ...
  return (
    <div className="w-[364px] bg-neutral-800 border border-gray-600 rounded p-4 group space-y-4">
      <Image src={image} alt="" width={256} height={512} className="object-fill max-h-72 w-full grayscale transition duration-300 group-hover:grayscale-0 rounded"/>
